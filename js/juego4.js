...
jQuery(document).ready(function($){
    $('#titulo').append('Fracciones');

    $('#img').attr({
        src: '../img/fracciones2.png'
    });

    $.getJSON("dat/juego4.json", function(dat){
        datos = dat;
        limite = datos.length;
    ...
    function $_preguntar(){
        ...
        $('#resp').click(function(event) {
            ...
            puntos[3].puntos = parseInt(puntos[3].puntos) + 1;
